ImiMaps::Application.routes.draw do
  ...
  resources :reports
  get 'assigned_reports/index'

  resources :assigned_reports
  ...
  scope "(:locale)", locale: /#{I18n.available_locales.join("|")}/ do
    ...
    resources :report_overview, :only => [:edit, :show, :index, :destroy, :update]

    resources :assigned_reports, :only => [:index]

    resources :reports, :only => [:edit, :show, :index, :destroy, :update]
